...
#define BACK_CAMERA_SENSOR_NAME  (SENSOR_NAME_S5K8B1)
#define FRONT_CAMERA_SENSOR_NAME (SENSOR_NAME_S5K2P2)
...
enum sensor_name {
    ...
    SENSOR_NAME_S5K8B1=1,
    SENSOR_NAME_S5K2P2=2,
    SENSOR_NAME_S5K3H2,
    SENSOR_NAME_S5K6A3,
    SENSOR_NAME_S5K4E5,
    SENSOR_NAME_S5K3H5,
    ...
    SENSOR_NAME_IMX135,
    SENSOR_NAME_S5K6B2,
    SENSOR_NAME_FAKE_S5K6A3,
    SENSOR_NAME_FAKE_S5K6B2,
    SENSOR_NAME_FAKE_IMX135,
...
/* my sensors */
struct ExynosCameraInfoS5K8B1 : public ExynosCameraInfo
{
public:
    ExynosCameraInfoS5K8B1();
};

struct ExynosCameraInfoS5K2P2 : public ExynosCameraInfo
{
public:
    ExynosCameraInfoS5K2P2();
};
...
/* my definitions again */

struct ExynosCameraInfoS5K8B1Reprocessing : public ExynosCameraInfoS5K8B1
{
public:
    ExynosCameraInfoS5K8B1Reprocessing();
};

struct ExynosCameraInfoS5K2P2Reprocessing : public ExynosCameraInfoS5K2P2
{
public:
    ExynosCameraInfoS5K2P2Reprocessing();
};
